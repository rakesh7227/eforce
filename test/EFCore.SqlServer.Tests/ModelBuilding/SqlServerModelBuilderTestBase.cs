...
public class SqlServerModelBuilderTestBase : RelationalModelBuilderTest
{
    ...
    public abstract class SqlServerJsonTestBase : RelationalJsonTestBase
    {
        [ConditionalFact]
        public virtual void Json_entity_and_normal_owned_can_exist_side_by_side_on_same_entity()
        {
            ...
            var reference = ownedEntities.Where(e => e.JsonColumnName() == "reference").Single();
            ...
            var collection = ownedEntities.Where(e => e.JsonColumnName() == "collection").Single();
        ...
        public virtual void Json_entity_with_tph_inheritance()
        {
            ...
            var jsonColumnNames = ownedEntities.Select(x => x.JsonColumnName()).OrderBy(x => x).ToList();
