...
#pragma warning restore EF1001 // Internal EF Core API usage.
                ...
                var json = CreateJson(navigationValue, currentEntry, currentOwnership.DeclaringEntityType, ordinal: null);
    ...
    private JsonNode CreateJson(object? navigationValue, IUpdateEntry parentEntry, IEntityType entityType, int? ordinal)
    {
        ...
        var enumerable = navigationValue as IEnumerable;
        if (enumerable != null)
        {
            var i = 1;
            ...
            {
                jsonNodes.Add(CreateJson(collectionElement, parentEntry, entityType, i++));
            }
...
#pragma warning restore EF1001 // Internal EF Core API usage.
        ...
        foreach (var property in entityType.GetDeclaredProperties())
        {
            ...
            var jsonPropertyName = property.JsonPropertyName();
        ...
        foreach (var navigation in entityType.GetDeclaredNavigations())
        {
            ...
            var navigationJson = CreateJson(ownedNavigationValue, entry, navigation.TargetEntityType, ordinal: null);
